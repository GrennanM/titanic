...
def main():
    ...
    # baseline_model = RandomForestClassifier(n_estimators=500, max_depth=None,
    ...
    # min_estimators = 15
    # max_estimators = 2000 # number of trees to try
    #
    ...
    # cross-validation
    # scores = cross_val_score(baseline_model, X, y, cv=10, n_jobs=5)
    # print (scores.mean())

    # fit Random Forest for submission
    # baseline_model.fit(X, y)
    # predictions = baseline_model.predict(test_df)
